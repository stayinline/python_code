...
def excel_to_postgresql_insert(excel_file, protocol_step_id, initial_sample_id, project_no, project_id):
    # 读取Excel文件
...
if __name__ == "__main__":
    ...
    # 默认值设置
    project_no = 'IPS_mock_project_no'
    project_id = 'IPS_mock_project_id'

    initial_sample_id = 'IPS_mock_initial_sample_id'

    excel_file = r"C:\Users\Mega\Documents\dingding_doc\IPS类器官实施\4样本换液记录1.xlsx"
    protocol_step_id = 'qilin_ips_organoid_02_01'

    # excel_file = r"C:\Users\Mega\Documents\dingding_doc\IPS类器官实施\12样本换液记录1.xlsx"
    # protocol_step_id = 'qilin_ips_organoid_04_01'

    # excel_file = r"C:\Users\Mega\Documents\dingding_doc\IPS类器官实施\18样本换液记录1.xlsx"
    # protocol_step_id = 'qilin_ips_organoid_05_02'


    try:
        # 生成SQL语句
        inserts, record_count = excel_to_postgresql_insert(excel_file, protocol_step_id, initial_sample_id, project_no,
                                                           project_id)
        ...
        if len(df) == record_count and record_count > 0:
            for i, sql in enumerate(inserts, 1):
                success, rows_affected = execute_sql_in_postgres(sql, db_config_suzhou)
