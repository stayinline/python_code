...
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_app_appdef
(
    `id_` String,
    `rev_` Int32,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_app_appdef', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_app_deployment
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_app_deployment
(
    `id_` String,
    `name_` Nullable(String),
    `category_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_app_deployment', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_app_deployment_resource
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_app_deployment_resource
(
    `id_` String,
    `name_` Nullable(String),
    `deployment_id_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_app_deployment_resource', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_cmmn_casedef
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_cmmn_casedef
(
    `id_` String,
    `rev_` Int32,
    `name_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_cmmn_casedef', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_cmmn_deployment
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_cmmn_deployment
(
    `id_` String,
    `name_` Nullable(String),
    `category_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_cmmn_deployment', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_cmmn_deployment_resource
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_cmmn_deployment_resource
(
    `id_` String,
    `name_` Nullable(String),
    `deployment_id_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_cmmn_deployment_resource', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_cmmn_hi_case_inst
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_cmmn_hi_case_inst
(
    `id_` String,
    `rev_` Int32,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_cmmn_hi_case_inst', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_cmmn_hi_mil_inst
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_cmmn_hi_mil_inst
(
    `id_` String,
    `rev_` Int32,
    `name_` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_cmmn_hi_mil_inst', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_cmmn_hi_plan_item_inst
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_cmmn_hi_plan_item_inst
(
    `id_` String,
    `rev_` Int32,
    `name_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_cmmn_hi_plan_item_inst', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_cmmn_ru_case_inst
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_cmmn_ru_case_inst
(
    `id_` String,
    `rev_` Int32,
    `business_key_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_cmmn_ru_case_inst', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_cmmn_ru_mil_inst
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_cmmn_ru_mil_inst
(
    `id_` String,
    `name_` String,
    `time_stamp_` DateTime,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_cmmn_ru_mil_inst', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_cmmn_ru_plan_item_inst
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_cmmn_ru_plan_item_inst
(
    `id_` String,
    `rev_` Int32,
    `case_def_id_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_cmmn_ru_plan_item_inst', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_cmmn_ru_sentry_part_inst
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_cmmn_ru_sentry_part_inst
(
    `id_` String,
    `rev_` Int32,
    `case_def_id_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_cmmn_ru_sentry_part_inst', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_dmn_decision
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_dmn_decision
(
    `id_` String,
    `name_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_dmn_decision', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_dmn_deployment
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_dmn_deployment
(
    `id_` String,
    `name_` Nullable(String),
    `category_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_dmn_deployment', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_dmn_deployment_resource
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_dmn_deployment_resource
(
    `id_` String,
    `name_` Nullable(String),
    `deployment_id_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_dmn_deployment_resource', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_dmn_hi_decision_execution
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_dmn_hi_decision_execution
(
    `id_` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_dmn_hi_decision_execution', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_evt_log
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_evt_log
(
    `log_nr_` Int32,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_evt_log', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_ge_bytearray
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_ge_bytearray
(
    `id_` String,
    `rev_` Nullable(Int32),
    `name_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_ge_bytearray', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_ge_property
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_ge_property
(
    `name_` String,
    `value_` Nullable(String),
    `rev_` Nullable(Int32)
)
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_ge_property', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_hi_actinst
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_hi_actinst
(
    `id_` String,
    `rev_` Nullable(Int32),
    `proc_def_id_` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_hi_actinst', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_hi_attachment
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_hi_attachment
(
    `id_` String,
    `rev_` Nullable(Int32),
    `user_id_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_hi_attachment', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_hi_comment
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_hi_comment
(
    `id_` String,
    `type_` Nullable(String),
    `time_` DateTime,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_hi_comment', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_hi_detail
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_hi_detail
(
    `id_` String,
    `type_` String,
    `proc_inst_id_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_hi_detail', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_hi_entitylink
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_hi_entitylink
(
    `id_` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_hi_entitylink', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_hi_identitylink
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_hi_identitylink
(
    `id_` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_hi_identitylink', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_hi_procinst
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_hi_procinst
(
    `id_` String,
    `rev_` Nullable(Int32),
    `proc_inst_id_` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_hi_procinst', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_hi_taskinst
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_hi_taskinst
(
    `id_` String,
    `rev_` Nullable(Int32),
    `proc_def_id_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_hi_taskinst', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_hi_tsk_log
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_hi_tsk_log
(
    `id_` Int32,
    `type_` Nullable(String),
    `task_id_` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_hi_tsk_log', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_hi_varinst
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_hi_varinst
(
    `id_` String,
    `rev_` Nullable(Int32),
    `proc_inst_id_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_hi_varinst', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_id_bytearray
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_id_bytearray
(
    `id_` String,
    `rev_` Nullable(Int32),
    `name_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_id_bytearray', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_id_group
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_id_group
(
    `id_` String,
    `rev_` Nullable(Int32),
    `name_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_id_group', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_id_info
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_id_info
(
    `id_` String,
    `rev_` Nullable(Int32),
    `user_id_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_id_info', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_id_membership
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_id_membership
(
    `user_id_` String,
    `group_id_` String
)
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_id_membership', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_id_priv
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_id_priv
(
    `id_` String,
    `name_` String
)
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_id_priv', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_id_priv_mapping
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_id_priv_mapping
(
    `id_` String,
    `priv_id_` String,
    `user_id_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_id_priv_mapping', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_id_property
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_id_property
(
    `name_` String,
    `value_` Nullable(String),
    `rev_` Nullable(Int32)
)
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_id_property', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_id_token
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_id_token
(
    `id_` String,
    `rev_` Nullable(Int32),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_id_token', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_id_user
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_id_user
(
    `id_` String,
    `rev_` Nullable(Int32),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_id_user', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_procdef_info
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_procdef_info
(
    `id_` String,
    `proc_def_id_` String,
    `rev_` Nullable(Int32),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_procdef_info', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_re_deployment
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_re_deployment
(
    `id_` String,
    `name_` Nullable(String),
    `category_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_re_deployment', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_re_model
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_re_model
(
    `id_` String,
    `rev_` Nullable(Int32),
    `name_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_re_model', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_re_procdef
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_re_procdef
(
    `id_` String,
    `rev_` Nullable(Int32),
    `category_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_re_procdef', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_ru_actinst
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_ru_actinst
(
    `id_` String,
    `rev_` Nullable(Int32),
    `proc_def_id_` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_ru_actinst', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_ru_deadletter_job
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_ru_deadletter_job
(
    `id_` String,
    `rev_` Nullable(Int32),
    `category_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_ru_deadletter_job', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_ru_entitylink
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_ru_entitylink
(
    `id_` String,
    `rev_` Nullable(Int32),
    `create_time_` Nullable(DateTime),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_ru_entitylink', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_ru_event_subscr
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_ru_event_subscr
(
    `id_` String,
    `rev_` Nullable(Int32),
    `event_type_` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_ru_event_subscr', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_ru_execution
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_ru_execution
(
    `id_` String,
    `rev_` Nullable(Int32),
    `proc_inst_id_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_ru_execution', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_ru_external_job
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_ru_external_job
(
    `id_` String,
    `rev_` Nullable(Int32),
    `category_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_ru_external_job', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_ru_history_job
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_ru_history_job
(
    `id_` String,
    `rev_` Nullable(Int32),
    `lock_exp_time_` Nullable(DateTime),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_ru_history_job', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_ru_identitylink
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_ru_identitylink
(
    `id_` String,
    `rev_` Nullable(Int32),
    `group_id_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_ru_identitylink', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_ru_job
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_ru_job
(
    `id_` String,
    `rev_` Nullable(Int32),
    `category_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_ru_job', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_ru_suspended_job
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_ru_suspended_job
(
    `id_` String,
    `rev_` Nullable(Int32),
    `category_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_ru_suspended_job', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_ru_task
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_ru_task
(
    `id_` String,
    `rev_` Nullable(Int32),
    `execution_id_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_ru_task', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_ru_timer_job
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_ru_timer_job
(
    `id_` String,
    `rev_` Nullable(Int32),
    `category_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_ru_timer_job', 'postgres', 'e2X4Fg&7b');


-- 源表：public.act_ru_variable
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_act_ru_variable
(
    `id_` String,
    `rev_` Nullable(Int32),
    `type_` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'act_ru_variable', 'postgres', 'e2X4Fg&7b');


-- 源表：public.flw_channel_definition
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_flw_channel_definition
(
    `id_` String,
    `name_` Nullable(String),
    `version_` Nullable(Int32),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'flw_channel_definition', 'postgres', 'e2X4Fg&7b');


-- 源表：public.flw_event_definition
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_flw_event_definition
(
    `id_` String,
    `name_` Nullable(String),
    `version_` Nullable(Int32),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'flw_event_definition', 'postgres', 'e2X4Fg&7b');


-- 源表：public.flw_event_deployment
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_flw_event_deployment
(
    `id_` String,
    `name_` Nullable(String),
    `category_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'flw_event_deployment', 'postgres', 'e2X4Fg&7b');


-- 源表：public.flw_event_resource
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_flw_event_resource
(
    `id_` String,
    `name_` Nullable(String),
    `deployment_id_` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'flw_event_resource', 'postgres', 'e2X4Fg&7b');


-- 源表：public.flw_ru_batch
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_flw_ru_batch
(
    `id_` String,
    `rev_` Nullable(Int32),
    `type_` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'flw_ru_batch', 'postgres', 'e2X4Fg&7b');


-- 源表：public.flw_ru_batch_part
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_flw_ru_batch_part
(
    `id_` String,
    `rev_` Nullable(Int32),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'flw_ru_batch_part', 'postgres', 'e2X4Fg&7b');


-- 源表：public.hplc_method
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_hplc_method
(
    `id` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'hplc_method', 'postgres', 'e2X4Fg&7b');


-- 源表：public.hplc_result
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_hplc_result
(
    `id` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'hplc_result', 'postgres', 'e2X4Fg&7b');


-- 源表：public.molecule_info
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_molecule_info
(
    `id` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'molecule_info', 'postgres', 'e2X4Fg&7b');


-- 源表：public.pipetting_record
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_pipetting_record
(
    `id` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'pipetting_record', 'postgres', 'e2X4Fg&7b');


-- 源表：public.plasmid_construction
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_plasmid_construction
(
    `id` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'plasmid_construction', 'postgres', 'e2X4Fg&7b');


-- 源表：public.plasmid_sequencing
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_plasmid_sequencing
(
    `id` String,
    `plasmid_name` Nullable(String),
    `clone_no` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'plasmid_sequencing', 'postgres', 'e2X4Fg&7b');


-- 源表：public.primer_info
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_primer_info
(
    `id` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'primer_info', 'postgres', 'e2X4Fg&7b');


-- 源表：public.project
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_project
(
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'project', 'postgres', 'e2X4Fg&7b') COMMENT '项目实体表';


-- 源表：public.purified_protein
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_purified_protein
(
    `id` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'purified_protein', 'postgres', 'e2X4Fg&7b');


-- 源表：public.sample_antigen
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_sample_antigen
(
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'sample_antigen', 'postgres', 'e2X4Fg&7b') COMMENT '抗原样本信息表';


-- 源表：public.sample_cell
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_sample_cell
(
    `sample_id` String COMMENT '主键ID',
    `source` Nullable(String) COMMENT '来源',
    `current_status` Nullable(String) COMMENT '状态',
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'sample_cell', 'postgres', 'e2X4Fg&7b') COMMENT '细胞样本信息表';


-- 源表：public.sample_plasmid
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_sample_plasmid
(
    `sample_id` String COMMENT '主键ID',
    `source` Nullable(String) COMMENT '来源',
    `current_status` Nullable(String) COMMENT '状态',
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'sample_plasmid', 'postgres', 'e2X4Fg&7b') COMMENT '质粒样本信息表';


-- 源表：public.sample_protein
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_sample_protein
(
    `sample_id` String COMMENT '主键ID',
    `source` Nullable(String) COMMENT '来源',
    `current_status` Nullable(String) COMMENT '状态',
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'sample_protein', 'postgres', 'e2X4Fg&7b') COMMENT '蛋白样本信息表';


-- 源表：public.sds_page
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_sds_page
(
    `id` String,
    `lane` Nullable(Int32),
    `barcode` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'sds_page', 'postgres', 'e2X4Fg&7b');


-- 源表：public.serial_number_sequence
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_serial_number_sequence
(
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'serial_number_sequence', 'postgres', 'e2X4Fg&7b') COMMENT '流水号表';


-- 源表：public.silver_layer_ai_seq_screening
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_ai_seq_screening
(
    `id` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_ai_seq_screening', 'postgres', 'e2X4Fg&7b');


-- 源表：public.silver_layer_bcr_sequencing
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_bcr_sequencing
(
    `id` String,
    `sequencing_batch` Nullable(String),
    `antigen_no` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_bcr_sequencing', 'postgres', 'e2X4Fg&7b');


-- 源表：public.silver_layer_bli_testing
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_bli_testing
(
    `id` String,
    `antigen_no` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_bli_testing', 'postgres', 'e2X4Fg&7b');


-- 源表：public.silver_layer_custom_table
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_custom_table
(
    `id` String,
    `c1` Nullable(String),
    `c2` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_custom_table', 'postgres', 'e2X4Fg&7b');


-- 源表：public.silver_layer_experiment
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_experiment
(
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_experiment', 'postgres', 'e2X4Fg&7b') COMMENT '实验实体表';


-- 源表：public.silver_layer_expression_and_purification
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_expression_and_purification
(
    `id` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_expression_and_purification', 'postgres', 'e2X4Fg&7b');


-- 源表：public.silver_layer_facs_sorting
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_facs_sorting
(
    `id` String,
    `antigen_no` Nullable(String),
    `animal_no` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_facs_sorting', 'postgres', 'e2X4Fg&7b');


-- 源表：public.silver_layer_ic50_testing
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_ic50_testing
(
    `id` String,
    `sample_name` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_ic50_testing', 'postgres', 'e2X4Fg&7b');


-- 源表：public.silver_layer_immunization_test_bleed
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_immunization_test_bleed
(
    `id` String,
    `antigen_no` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_immunization_test_bleed', 'postgres', 'e2X4Fg&7b');


-- 源表：public.silver_layer_in_vitro_testing
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_in_vitro_testing
(
    `id` String,
    `antigen_no` Nullable(String),
    `antibody_id` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_in_vitro_testing', 'postgres', 'e2X4Fg&7b');


-- 源表：public.silver_layer_molecule_chain_info
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_molecule_chain_info
(
    `id` String,
    `molecule_name` Nullable(String),
    `chain_name` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_molecule_chain_info', 'postgres', 'e2X4Fg&7b');


-- 源表：public.silver_layer_primer_return_info
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_primer_return_info
(
    `id` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_primer_return_info', 'postgres', 'e2X4Fg&7b');


-- 源表：public.silver_layer_protocol
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_protocol
(
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_protocol', 'postgres', 'e2X4Fg&7b') COMMENT '实验流程实体表';


-- 源表：public.silver_layer_rec_plasmid_const
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_rec_plasmid_const
(
    `id` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_rec_plasmid_const', 'postgres', 'e2X4Fg&7b');


-- 源表：public.silver_layer_record_cell_count
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_record_cell_count
(
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_record_cell_count', 'postgres', 'e2X4Fg&7b') COMMENT '细胞计数信息表';


-- 源表：public.silver_layer_record_centrifuge
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_record_centrifuge
(
    `id` String COMMENT '主键ID',
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_record_centrifuge', 'postgres', 'e2X4Fg&7b') COMMENT '离心机运行记录表';


-- 源表：public.silver_layer_record_culture
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_record_culture
(
    `id` String COMMENT '主键ID',
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_record_culture', 'postgres', 'e2X4Fg&7b') COMMENT '培养记录表';


-- 源表：public.silver_layer_record_microplate_assay
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_record_microplate_assay
(
    `id` String COMMENT '主键ID',
    `barcode` Nullable(String) COMMENT '条形码',
    `sample_name` Nullable(String) COMMENT '样本名称',
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_record_microplate_assay', 'postgres', 'e2X4Fg&7b') COMMENT '酶标仪检测信息表';


-- 源表：public.silver_layer_record_move_sample
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_record_move_sample
(
    `id` String COMMENT '主键ID',
    `sample_name` Nullable(String) COMMENT '样本名称',
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_record_move_sample', 'postgres', 'e2X4Fg&7b') COMMENT '转孔记录表';


-- 源表：public.silver_layer_role
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_role
(
    `id` String COMMENT '主键ID',
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_role', 'postgres', 'e2X4Fg&7b') COMMENT '角色表';


-- 源表：public.silver_layer_sample_antigen
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_sample_antigen
(
    `sample_id` String COMMENT '主键ID',
    `source` Nullable(String) COMMENT '来源',
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_sample_antigen', 'postgres', 'e2X4Fg&7b');


-- 源表：public.silver_layer_sample_cell
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_sample_cell
(
    `sample_id` String COMMENT '主键ID',
    `source` Nullable(String) COMMENT '来源',
    `current_status` Nullable(String) COMMENT '状态',
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_sample_cell', 'postgres', 'e2X4Fg&7b') COMMENT '细胞样本信息表';


-- 源表：public.silver_layer_sample_plasmid
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_sample_plasmid
(
    `sample_id` String COMMENT '主键ID',
    `source` Nullable(String) COMMENT '来源',
    `current_status` Nullable(String) COMMENT '状态',
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_sample_plasmid', 'postgres', 'e2X4Fg&7b') COMMENT '质粒样本信息表';


-- 源表：public.silver_layer_sample_protein
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_sample_protein
(
    `sample_id` String COMMENT '主键ID',
    `source` Nullable(String) COMMENT '来源',
    `current_status` Nullable(String) COMMENT '状态',
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_sample_protein', 'postgres', 'e2X4Fg&7b') COMMENT '蛋白样本信息表';


-- 源表：public.silver_layer_solubility_testing
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_solubility_testing
(
    `id` String,
    `testing_batch` Nullable(String),
    `sample_name` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_solubility_testing', 'postgres', 'e2X4Fg&7b');


-- 源表：public.silver_layer_sop
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_sop
(
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_sop', 'postgres', 'e2X4Fg&7b') COMMENT 'SOP信息表';


-- 源表：public.silver_layer_tm_testing
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_tm_testing
(
    `id` String,
    `testing_batch` Nullable(String),
    `sample_name` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_tm_testing', 'postgres', 'e2X4Fg&7b');


-- 源表：public.silver_layer_user
CREATE TABLE IF NOT EXISTS workflow_test.silver_layer_user
(
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'silver_layer_user', 'postgres', 'e2X4Fg&7b') COMMENT '人员实体表';


-- 源表：public.workflow_attachment
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_workflow_attachment
(
    `id` String,
    `attachment` Nullable(String),
    `block_id` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'workflow_attachment', 'postgres', 'e2X4Fg&7b');


-- 源表：public.workflow_autobio_data
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_workflow_autobio_data
(
    `id` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'workflow_autobio_data', 'postgres', 'e2X4Fg&7b');


-- 源表：public.workflow_data_job
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_workflow_data_job
(
    `id` String,
    `run_id` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'workflow_data_job', 'postgres', 'e2X4Fg&7b');


-- 源表：public.workflow_data_transform_rule
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_workflow_data_transform_rule
(
    `id` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'workflow_data_transform_rule', 'postgres', 'e2X4Fg&7b');


-- 源表：public.workflow_edge
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_workflow_edge
(
    `id` String COMMENT '主键ID',
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'workflow_edge', 'postgres', 'e2X4Fg&7b') COMMENT '工作流模板连线表';


-- 源表：public.workflow_file
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_workflow_file
(
    `id` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'workflow_file', 'postgres', 'e2X4Fg&7b');


-- 源表：public.workflow_import_template
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_workflow_import_template
(
    `id` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'workflow_import_template', 'postgres', 'e2X4Fg&7b');


-- 源表：public.workflow_model
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_workflow_model
(
    `id` String,
    `model_name` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'workflow_model', 'postgres', 'e2X4Fg&7b');


-- 源表：public.workflow_model_group
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_workflow_model_group
(
    `id` String,
    `group_name` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'workflow_model_group', 'postgres', 'e2X4Fg&7b');


-- 源表：public.workflow_node
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_workflow_node
(
    `id` String COMMENT '主键ID',
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'workflow_node', 'postgres', 'e2X4Fg&7b') COMMENT '工作流模板节点信息表';


-- 源表：public.workflow_node_context
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_workflow_node_context
(
    `id` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'workflow_node_context', 'postgres', 'e2X4Fg&7b');


-- 源表：public.workflow_node_template
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_workflow_node_template
(
    `id` String,
    `template_name` Nullable(String),
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'workflow_node_template', 'postgres', 'e2X4Fg&7b');


-- 源表：public.workflow_rich_text
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_workflow_rich_text
(
    `id` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'workflow_rich_text', 'postgres', 'e2X4Fg&7b');


-- 源表：public.workflow_sample_tracking
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_workflow_sample_tracking
(
    `id` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'workflow_sample_tracking', 'postgres', 'e2X4Fg&7b');


-- 源表：public.workflow_template
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_workflow_template
(
    `id` String COMMENT '主键ID',
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'workflow_template', 'postgres', 'e2X4Fg&7b') COMMENT '工作流模板表';


-- 源表：public.workflow_textarea
CREATE TABLE IF NOT EXISTS workflow_test.bronze_layer_workflow_textarea
(
    `id` String,
...
ENGINE = PostgreSQL('10.10.2.30', 'labillion-workflow', 'workflow_textarea', 'postgres', 'e2X4Fg&7b');
